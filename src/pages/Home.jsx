...
function Home() {
  ...
  return (
    <div className="w-screen h-screen fixed top-0 left-0 flex items-center justify-center bg-gray-500">
      <div className="w-[800px] rounded-2xl bg-white mx-2 mb-10">
        <div className="flex flex-col md:flex-row  h-[600px] xl:mb-0  xl:h-[700px] w-full">
